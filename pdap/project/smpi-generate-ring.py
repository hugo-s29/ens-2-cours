...
if len(sys.argv) != 6:
  print(
      "Usage: smpi-generate-ring.py <num hosts> <real-machine-compute-power> <simulation-node-compute-power> <simulation-link-bandwidth> <simulation-link-latency> \n",
      file=sys.stderr,
  )
  print("Example: smpi-generate-ring.py 32 1000 100 10Gbps 10us \n",
        file=sys.stderr)
  print(
      "  Will generate a ring-<num hosts>-platform.xml and ring-<num hosts>-hostfile.txt file\n",
      file=sys.stderr,
  )
  exit(1)
