...
\begin{document}
  ...
  % TODO Diagramme de ruban avec ...x...#...f(|x|)...

  \begin{figure}
    \centering
    \begin{tikzpicture}
      %\directlua{draw_tape({name = 'in', label='', n = 15, content = {'$x_1$', '$x_2$', '...', '$x_n$', '\\texttt{\\#}', '$f(n)_1$',  '$f(n)_2$', '...', '$f(n)_k$'}, head_pos = 1}, 0)}
    \end{tikzpicture}
    \caption{Machine avec fonction de conseil\footnote{où on construit $\code{\cdot,\cdot}$ avec un séparateur $\texttt{\#}$.}}
  \end{figure}
