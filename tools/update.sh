...
if [ "$HOSTNAME" = "s-1vcpu-1gb-lon1-01" ]; then
  ...
  cp ip/presentation2.pdf ../web/public/data/ens2/ip-presentation2.pdf
  ...
  cp cc/chap04.pdf ../web/public/data/ens2/cc-chap04.pdf
  cp cc/chap05.pdf ../web/public/data/ens2/cc-chap05.pdf
  cp cc/chap06.pdf ../web/public/data/ens2/cc-chap06.pdf
  cp cc/chap07.pdf ../web/public/data/ens2/cc-chap07.pdf
  cp cc/chap08.pdf ../web/public/data/ens2/cc-chap08.pdf

  cp cgdi/report.pdf ../web/public/data/ens2/cgdi-report.pdf
  cp cgdi/slides.pdf ../web/public/data/ens2/cgdi-slides.pdf

  cp dbdm/td.pdf ../web/public/data/ens2/dbdm-td.pdf
  cp dbdm/recap.pdf ../web/public/data/ens2/dbdm-recap.pdf
