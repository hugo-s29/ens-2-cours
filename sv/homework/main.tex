...
\begin{document}
  ...
  On the other hand, if $\lnot a \in \mathcal{F}$ then necessarily $a \in \mathcal{F}$ by $(\star)$.
  ...
  Thus $a, \lnot a \in \mathcal{H}$ and so $a \wedge \lnot a = \bot  \in \mathcal{H}$, a contradiction since $\mathcal{H}$ is a proper filer.
  ...
  \begin{enumerate}
    ...
    \item Suppose $\chi_{\mathcal{F}}$ is a morphism of meet semilattices.
      ...
      Also, $\chi_{\mathcal{F}}(\top) = \top_{\mathbf{2}} = 1$, thus $\top_{\mathcal{F}} \in \mathcal{F}$.
  ...
  \begin{lem}
    ...
    \begin{itemize}
      ...
      \item if $\mathcal{F}$ is a proper filter, then $a \vee b \not\in \mathcal{F}$ iff $a, b \not\in \mathcal{F}$.
    \qed
    \end{itemize}
  \end{lem}
